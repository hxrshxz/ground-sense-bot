          ...
          <AnimatePresence>
            {chatHistory.map((msg, index) => {
              ...
              return (
                ...
                >
                  {" "}
                  {/* CHANGED: Increased gap and max-width of messages */}
                  {msg.type === "ai" && (
                  ...
                  <div className="max-w-2xl">
                    ...
                    {msg.type === "user" ? (
                      ...
                      >
                        {" "}
                        {/* CHANGED: Increased padding and text size */}
                        {isLastMessage ? (
