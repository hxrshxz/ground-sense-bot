    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {items.map((k) => {
        ...
        return (
          <div
            key={k.label}
            className="relative group p-3 rounded-xl border border-slate-200 bg-gradient-to-br from-white via-slate-50 to-slate-100 shadow-sm overflow-hidden"
          >
            ...
            <div className="text-base font-bold text-slate-800 tabular-nums leading-none mb-0.5">
              {k.value}
            </div>
            {k.change != null && (
              <div
