...
const testGroundwaterAnalysisFlow = () => {
  ...
  const sampleGroundwaterData = {
    summary:
      "Analysis shows Delhi and Chaksu block are at high risk with extraction exceeding recharge.",
    problem_districts: [
      {
        district: "New Delhi",
        category: "Over-Exploited",
        reason: "Extraction exceeds recharge by 29%",
      },
    ],
    sector_usage: [
      {
  ...
  console.log(
    "✅ GroundwaterAnalysisChart - Extraction vs Recharge with interactive filters"
  );
  console.log("✅ SectorUsageChart - Pie/Bar chart for water usage by sector");
  console.log(
    "✅ AnnualTrendsChart - Multi-year trend analysis with sustainability metrics"
  );
  console.log(
    "✅ GroundwaterAnalysisRenderer - Main component that detects and renders all charts"
  );

  console.log("\n🎯 Flow Summary:");
  console.log(
    "1. User types: 'Analyzing uploaded INGRES map image with comprehensive groundwater analysis...'"
  );
  ...
  console.log(
    "4. GroundwaterAnalysisRenderer detects the response and displays interactive charts"
  );
  console.log(
    "5. User sees beautiful water-based visualizations similar to your financial chart example"
  );
